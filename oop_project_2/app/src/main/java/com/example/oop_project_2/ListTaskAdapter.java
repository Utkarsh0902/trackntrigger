...
public class ListTaskAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        com.example.oop_project_2.ListTaskViewHolder holder = null;
        if (convertView == null) {
            holder = new com.example.oop_project_2.ListTaskViewHolder();
            ...
            holder = (com.example.oop_project_2.ListTaskViewHolder) convertView.getTag();
        }


        final HashMap<String, String> singleTask = data.get(position);
        final com.example.oop_project_2.ListTaskViewHolder tmpHolder = holder;
