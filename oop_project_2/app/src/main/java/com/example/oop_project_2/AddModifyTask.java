...
public class AddModifyTask extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateText.setText(new SimpleDateFormat("E, dd MMMM yyyy,H:mm").format(calendar.getTime()));
    ...
    public void init_modify() {
        ...
        if (task != null) {
            ...
            SimpleDateFormat iso8601Format = new SimpleDateFormat("yyyy-MM-dd,H:mm");
            try {
    ...
    public void saveTask(View v) {
        ...
        if (edit_text.getText().toString().trim().length() > 0) {
            ...
            if (isModify) {
                mydb.updateTask(task_id, edit_text.getText().toString(), new SimpleDateFormat("yyyy-MM-dd HH:mm").format(calendar.getTime()));
                Toast.makeText(getApplicationContext(), "Task Updated.", Toast.LENGTH_SHORT).show();
            } else {
                mydb.insertTask(edit_text.getText().toString(), new SimpleDateFormat("yyyy-MM-dd HH:mm").format(calendar.getTime()));
